...
namespace SteamLobby
{
    public class InventorySlotUI : MonoBehaviour
    {
        ...
        public void SetItem(ItemUI item, InventorySlotUI sourceSlot, bool addingItem)
        {
            if (item == null)
            {
            ...
            else if (IsEmpty() && !addingItem) // To avoid other items moving back to original slot
            {
